...
import { addselectedPost, changeLike, removeselectedPost } from "../utils/selectedPostSlice";
...
const PostPage = () => {
  ...
  const { likes, comments } = useSelector((slice) => slice.post);
          ...
          <div className="p-8">
            ...
            <div className="flex items-center gap-3 mt-5 text-gray-500">
              <div className="h-9 w-9 overflow-hidden rounded-full">
                <img
                  src={`https://api.dicebear.com/9.x/initials/svg?seed=${postData?.creator?.name}`}
                  alt="Profile"
            ...
            <div className="flex gap-4 mt-8">
              ...
              <div className="flex items-center gap-2 text-xl">
                <MdInsertComment className="text-green-500 text-3xl" onClick={() => dispatch(setIsOpen())} />
